...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        $this->call([roleSeeder::class,userSeeder::class,fieldSeeder::class,child_fieldSeeder::class,matchSeeder::class,price_fieldSeeder::class,
                    ...
                    detail_notificationSeeder::class,orderSeeder::class,TeamSeeder::class,Team_DetailSeeder::class, StatusOfferSeeder::class, TeamCommentSeeder::class,userCommentSeeder::class]);
    }
}
